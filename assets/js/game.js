...
namespace IT_Game.Algorithm
{
    ...
    {
        /// <summary>
        /// hash code multiplier for building hash code from multiple items.
        /// It is a prime.
        /// </summary>
        public const int HashCodeMultipler = 397;

        /// <summary>
        /// build hash code from multiple items
        /// </summary>
        /// <param name="start">
        /// initial value for hash code
        /// </param>
        /// <param name="items">
        /// items to build hash code from.
        /// </param>
        /// <returns>
        /// hash code
        /// </returns>
        public static int GetHashCode(int start, params object[] items)
        {
            var code = start;
            ...
            unchecked
            {
                foreach (var item in items)
                    code = (code * HashCodeMultipler) ^ item.GetHashCode();
            }
            return code;
        }
        ...
        public class FigureEventArgs : EventArgs
        {
            ...
            /// </summary>
            public readonly FigureAction action;

            /// <summary>
            /// constructor
            /// </summary>
            public FigureEventArgs(GamePlayer p, GameFigure f, FigureAction a)
            {
                this.player = p;
                this.figure = f;
                this.action = a;
        ...
        public class ParkingEventArgs : EventArgs
        {
            ...
            /// </summary>
            public readonly GamePoint[] positions;
            ...
            /// constructor
            /// </summary>
            public ParkingEventArgs(GamePoint[] p, bool a)
            {
                this.positions = p;
                this.action = a;
            }
        ...
        public class FinishedEventArgs : EventArgs
        {
            ...
            /// constructor
            /// </summary>
            public FinishedEventArgs(GamePlayer p = null)
            {
                this.player = p;
            }
        }
        ...
        public sealed class GamePoint
        {
            ...
            /// <summary>
            /// constructor to set position from field point
            /// </summary>
            /// <param name="p">
            /// field position
            /// </param>
            public GamePoint(Field.Point p)
            {
                this.Col = p.Col;
                this.Row = p.Row;
            }
            ...
            /// point 1 == point 2
            /// </returns>
            public static bool Equals(GamePoint a, GamePoint b)
            {
                if (a is null ||
                    b is null)
                    return false;
            ...
            /// <summary>
            /// equals function for generic lists etc.
            /// </summary>
            /// <param name="obj">
            /// game point to compare
            /// </param>
            /// <returns>
            /// point is equal
            /// </returns>
            ...
            {
                return Equals(this, obj as GamePoint);
            }

            /// <summary>
            /// build hash value of point for generic list etc.
            /// </summary>
            /// <returns>
            /// hash value
            /// </returns>
            ...
            {
                return Game.GetHashCode(0, this.Col, this.Row);
            }
        }
        ...
        public class GameFigure
        {
            ...
            /// number of figure
            /// </param>
            public GameFigure(GamePlayer p, int n)
            {
                this.Player = p;
                this.Number = n;
            }
            ...
            /// figure to copy
            /// </param>
            public GameFigure(GameFigure f)
            {
            ...
            public GameFigure(GamePlayer p, int row, int col)
            {
                this.Player = p;
            ...
            /// </summary>
            public bool Test { set; private get; }
            ...
            /// </summary>
            public bool InField { get; private set; }
            ...
            public static bool HaveSameColor(GameFigure f1, GameFigure f2)
            {
                return Field.Player.Equals(f1.Player.FieldPlayer, f2.Player.FieldPlayer);
            }

            /// <summary>
            /// check if figure is equal, for generic lists etc.
            /// </summary>
            /// <param name="obj">
            /// figure to check
            /// </param>
            ...
            public override bool Equals(object obj)
            {
                return Equals(this, obj as GameFigure);
            }

            /// <summary>
            /// get hash code of class
            /// </summary>
            /// <returns>
            /// hash code
            /// </returns>
            public override int GetHashCode()
            {
                return Game.GetHashCode(0, this.Position, this.Number, this.Player);
            }
            ...
            /// figure 1 == figure 2
            /// </returns>
            public static bool Equals(GameFigure a, GameFigure b)
            {
            ...
            /// </returns>
            public bool CheckStart(bool all = false)
            {
                if (all)
                {
            ...
            {
                if (this.Player.FieldPlayer is null)
        ...
        public class GamePlayer
        {
            ...
            /// </param>
            public GamePlayer(Game game, int player)
            {
            ...
            private void CreateFigures()
            {
                ...
                for (int n = 1; n <= Field.GameMaxFigure; n++)
                {
                    var f = new GameFigure(this, n);

                    if (!(this.Game.OnFigure is null))
            ...
            /// <summary>
            /// check if player is equal, for generic lists etc.
            /// </summary>
            /// <param name="obj">
            /// player to check
            /// </param>
            ...
            public override bool Equals(object obj)
            {
                return Equals(this, obj as GamePlayer);
            }

            /// <summary>
            /// get hash code of the class
            /// </summary>
            /// <returns>
            /// hash code
            /// </returns>
            public override int GetHashCode()
            {
                return this.FieldPlayer.GetHashCode();
            }
            ...
            /// player are equal
            /// </returns>
            public static bool HaveSameColor(GamePlayer p1, GamePlayer p2)
            {
            ...
            /// players are equal
            /// </returns>
            public static bool Equals(GamePlayer a, GamePlayer b)
            {
                if (a is null ||
                    b is null)
                    return false;
            ...
            /// </summary>
            public Field.Player FieldPlayer { get; }
            ...
            /// figure found
            /// </returns>
            public GameFigure GetFigure(int number)
            {
            ...
            public void SetFiguresToCorner(bool force = false)
            {
                ...
                {
                    foreach (var fig in this.Figures.Where(f => f.InField))
                        fig.SetCorner();
                }
            }
            ...
            /// figure
            /// </returns>
            public GameFigure GetFigureFromCorner()
            {
        ...
        /// Null if one already has been tracked.
        /// </returns>
        public GameFigure[] CheckDiceRoll(int dice, out GameFigure[] fdefeat, out GameFigure fset)
        {
            fdefeat = null;
            fset = null;
